...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.set_configs(self.config_name.INDEX, self.extract_platform_dep_settings({"win32": {"7": {"compare-threshold": 0.01}}}))

    def test_firefox_gsearch_ilft_select_image_cat(self):
